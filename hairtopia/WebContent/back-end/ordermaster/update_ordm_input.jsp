...
<head>
<meta charset="UTF-8">
<title>訂單主檔資料修改 - update_ordm_input.jsp</title>
</head>
<body bgcolor='white'>
	<table id="table-1">
		<tr>
			<td>
				<h3>訂單主檔資料修改 - update_ordm_input.jsp</h3>
				<h4>
	...
	<br> <input type="hidden" name="action" value="update"> 
		 <input type="hidden" name="ordNo" value="<%=ordmVO.getOrdNo()%>">
