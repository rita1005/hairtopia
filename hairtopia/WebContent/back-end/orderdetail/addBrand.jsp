...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			<td>
				<h3>訂單明細資料新增 - addOrderDetail.jsp</h3>
			</td>
			<td>
				<h4>
	...
	<form METHOD="POST" ACTION="<%=request.getContextPath()%>/orderdetail/orderdetail.do" name="form1" enctype="multipart/form-data">
		<table>
			<tr>
				<td>訂單編號:</td>
				<td><input type="TEXT" name="ordNo" size="45"
					value="<%= (orderdetailVO == null) ? "" : orderdetailVO.getOrdNo()%>" /></td>
					
			</tr>
			<tr>
				<td>商品編號:</td>
				<td><input type="TEXT" name="proNo" size="45"
					value="<%= (orderdetailVO == null) ? "" : orderdetailVO.getProNo()%>" /></td>
					
			</tr>
			<tr>
				<td>訂購數量</td>
				<td><input type="TEXT" name="ordDetAmt" size="45"
					value="<%= (orderdetailVO == null) ? "" : orderdetailVO.getOrdDetAmt()%>" /></td>
			</tr>
			<tr>
				<td>明細金額</td>
				<td><input type="TEXT" name="ordDetPrice" size="45"
					value="<%= (orderdetailVO == null) ? "" : orderdetailVO.getOrdDetPrice()%>" /></td>
			</tr>
